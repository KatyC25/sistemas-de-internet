...
const Productos = () => {
	...
	const manejoCambioInputEditar = (e) => {
		...
		if (name === "imagen" && files && files[0]) {
			...
			if (file.size > 1024 * 1024) {
				// 1MB = 1024*1024 bytes
				alert("La imagen no debe superar 1MB de tamaño.");
				return;
			}
	...
	// Filtrar productos cada vez que cambian productos, categorias o textoBusqueda
	useEffect(() => {
	...
	}, [productos, categorias, textoBusqueda]);
